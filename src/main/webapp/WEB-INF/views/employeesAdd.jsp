...
<body>
	...
	<tr><td>	Entrer le prenom: </td><td><form:input path="prenom"/></td></tr>
	<tr><td>	Entrer le mail: </td><td><form:input path="mail"/></td></tr>
	<tr><td>	Entrer le telephone: </td><td><form:input path="tel"/></td></tr>
